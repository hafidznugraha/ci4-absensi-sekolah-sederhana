    ...
    <nav class="navbar navbar-expand bg-white border-bottom shadow-sm d-none d-md-flex position-fixed top-0 start-0 end-0 px-4 py-2 z-3">
        <div class="container-fluid d-flex justify-content-between align-items-center">
            <div class="d-flex align-items-center gap-2">
                <img src="<?= base_url('assets/img/logo.png') ?>" style="height:36px">
            ...
            <div class="d-flex gap-4 text-center">
                ...
                <a href="<?= base_url('siswa/riwayat') ?>"
                    class="nav-link text-dark <?= service('uri')->getSegment(2) === 'riwayat' ? 'fw-bold text-primary' : '' ?>">
    ...
    <div class="container d-flex justify-content-center py-5">
        <div class="card profile-card">
            ...
            <div class="profile-body">
                ...
                <p><strong>NIS:</strong> <?= esc($user['nis']) ?></p>
