...
<head>
    ...
    <style>
        ...
        @media (max-width: 576px) {
            ...
            /* Tambahan agar tidak nempel dengan navbar bawah */
            .container {
...
<body>
    ...
    <div class="container mt-2 px-2">
        <div class="d-md-flex justify-content-between align-items-center mb-3">
            ...
            <div class="btn-group-mobile mt-2 mt-md-0">
                <a href="<?= base_url('admin/siswa/rekap-pdf') ?>" target="_blank" class="btn btn-outline-danger">
    ...
    <div class="modal fade" id="modalTambah" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <form action="<?= base_url('admin/siswa/tambah') ?>" method="post" class="modal-content">
    ...
    <div class="modal fade" id="modalEdit" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <form action="<?= base_url('admin/siswa/update') ?>" method="post" class="modal-content">
